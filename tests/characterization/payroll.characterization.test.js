/**
 * Characterization tests — lock CURRENT legacy behavior.
 * Do NOT "fix" expected values to match ideal behavior.
 */
import {
  calculatePayroll,
  resetGlobalStats,
  getGlobalStats,
} from '../../original/payroll-calculator.js';

function clone(obj) {
  return JSON.parse(JSON.stringify(obj));
}

describe('Characterization: Employee Payroll Calculator (legacy)', () => {
  beforeEach(() => {
    resetGlobalStats();
  });
  ...
  // --- Mutations & global state (document side effects) ---
  ...
  // --- Float behavior (legacy rounding) ---
